<div role="tabpanel" class="tab-pane" id="creationSpectacle">
		...
		<!-- GOD MOD SEULEMENT -->
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<label class="radio-inline">
						<input type="radio" name="radioVedette" id="radioVedette2" value="option2"> Non
					</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<label class="radio-inline">
						<input type="radio" name="radioVisible" id="radioVisible1" value="option1"> Oui
					</label>
					<label class="radio-inline">
