...
<div class="row shows small-gutter">
	...
	<?php for ($i = 1; $i < 12; $i++) : ?>
		...
		<?php if ($i == 3) : ?>
			<article class="show-item col-sm-12 col-md-6 col-lg-4">
				<a href="http://google.com" target="_blank">
					<img alt="image du spectacle" src="images/pseudo-pub-2.jpg" />
		...
		<?php if ($i == 6) : ?>
			<a onclick="window.open('http://google.com');" title="Publicité" class="paraxify col-sm-12" style='background-image:url("images/pseudo-pub-7.jpg")'></a>
		<?php endif; ?>
